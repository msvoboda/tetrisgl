...
/***********************************************
*                                              *
*    Michal Svoboda's Revised OpenGL Basecode  *
*                     2002                     *
*                    TETRIS                    *
***********************************************/


#define FULLSCREEN_ASK // jestli chcu prepnout do full screenu
// Includes
#ifdef WIN32																
#include <windows.h>													
#else																		
	...
	int main(int argc, char **argv)												// Our Main Funcion!
{
	...
	if(MessageBox(HWND_DESKTOP, "Pøepnout do FullScreen?",				// With a MessageBox Call
